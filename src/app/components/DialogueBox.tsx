...
const DialogueBox = () => {
  ...
  const handleAddTask = (e: React.FormEvent) => {
    ...
    addTask(trimmedTitle, status === "complete");
          ...
          <form onSubmit={handleAddTask}>
            <label className="flex flex-col text-xl text-gray-200">
              ...
              <input
                type="text"
                autoFocus
                className="bg-slate-800 h-10 text-gray-300 text-base font-light p-2 mb-6 mt-2 rounded-md outline-none focus:ring-2 focus:ring-blue-400 capitalize"
                value={title}
